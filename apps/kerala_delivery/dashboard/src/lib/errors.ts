...
export const ERROR_HELP_URLS: Record<string, string> = {
  ...
  UPLOAD_FILE_TOO_LARGE: "/docs/CSV_FORMAT.md#file-level-errors",
  UPLOAD_EMPTY_FILE: "/docs/CSV_FORMAT.md#file-level-errors",
  UPLOAD_NO_VALID_ORDERS: "/docs/CSV_FORMAT.md#row-level-errors",
  UPLOAD_NO_ALLOCATED: "/docs/CSV_FORMAT.md#cdcms-format",
  GEOCODING_NOT_CONFIGURED: "/docs/GOOGLE-MAPS.md#api-key-setup",
  GEOCODING_QUOTA_EXCEEDED: "/docs/GOOGLE-MAPS.md#quota",
  GEOCODING_FAILED: "/docs/GOOGLE-MAPS.md#troubleshooting",
  OPTIMIZER_UNAVAILABLE: "/docs/SETUP.md#osrm-vroom",
  OPTIMIZER_TIMEOUT: "/docs/SETUP.md#osrm-vroom",
  OPTIMIZER_ERROR: "/docs/SETUP.md#osrm-vroom",
  FLEET_NO_VEHICLES: "/docs/SETUP.md#fleet-setup",
  AUTH_KEY_INVALID: "/docs/SETUP.md#api-key",
  AUTH_KEY_MISSING: "/docs/SETUP.md#api-key",
  SERVICE_UNAVAILABLE: "/docs/SETUP.md#services",
};
