...
> **Office employees:** Start with [DEPLOY.md](DEPLOY.md) for system setup and daily operations.

Each document is tagged with its intended audience:

- **Office Employee** -- No programming knowledge required. Plain English instructions.
- **Developer** -- Technical documentation for contributors and maintainers.
